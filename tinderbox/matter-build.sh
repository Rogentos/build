...
this is isomorphos.argentsmth.org informing you that a new matter run has been
eventually executed.
...
Thanks for reading." | mutt -s "${schedule} matter run, $(basename ${LOG_FILE})" -a "${LOG_FILE}.bz2" -- entropy-team@lists.argentsmth.org
